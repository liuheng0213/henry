...
import basic.knowledge.henry.algorithm.InterverviewFromRenowedITCompany._06bigDatAndSpaceLimitaion.BaseBitSet;
import basic.knowledge.henry.algorithm.InterverviewFromRenowedITCompany._06bigDatAndSpaceLimitaion.MessageDigestUtils;
...
public class BloomFilter<E> implements Cloneable, Serializable {
    ...
    private basic.knowledge.henry.algorithm.InterverviewFromRenowedITCompany._06bigDatAndSpaceLimitaion.BaseBitSet bitSet;
     ...
     * @param bitSet
     */
    public void bind(basic.knowledge.henry.algorithm.InterverviewFromRenowedITCompany._06bigDatAndSpaceLimitaion.BaseBitSet bitSet) {
        this.bitSet = bitSet;
    }
     ...
     */
    public BloomFilter(int bitSetSize, int expectedNumberOfFilterElements, int actualNumberOfFilterElements, basic.knowledge.henry.algorithm.InterverviewFromRenowedITCompany._06bigDatAndSpaceLimitaion.BaseBitSet filterData) {
